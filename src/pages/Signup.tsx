...
export default function SignupForm({ onSwitchToLogin }: SignupFormProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-200 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-gradient-to-b from-white to-gray-50 border-gray-300 shadow-2xl">
        ...
        <CardContent className="space-y-4">
          <form className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full  bg-black hover:bg-white hover:text-black text-white border-0 cursor-pointer duration-100 transition-all hover:border-[1px] border-gray-300"
            >
              Create Account
            </Button>
          </form>
          ...
          {/* <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-gradient-to-b from-white to-gray-50 px-2 text-gray-600">Or continue with</span>
            </div>
          </div> */}
          ...
          {onSwitchToLogin && (
            <div className="text-center">
              ...
              <button
                ...
                className="ml-2 text-sm text-gray-900 hover:text-gray-700 transition-colors font-medium"
              >
                Sign in
              </button>
            </div>
